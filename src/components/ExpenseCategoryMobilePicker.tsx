...
export const ExpenseCategoryMobilePicker: React.FC<ExpenseCategoryMobilePickerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col md:hidden">
      ...
      <div
        className="absolute bottom-0 left-0 right-0 max-h-[85vh] flex flex-col rounded-t-2xl bg-white shadow-xl"
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-4 pb-4">
                ...
                {popularFiltered.map((cat) => (
                  <li key={cat.id}>
                    <button
                      ...
                      className="w-full text-left rounded-xl px-4 py-3 text-gray-900 hover:bg-gray-100 active:bg-gray-200 flex items-center"
          ...
          <div className="space-y-2 pt-2 border-t">
            <button
              ...
              className="w-full rounded-xl px-4 py-3 text-left text-blue-600 font-medium hover:bg-blue-50 active:bg-blue-100"
              style={{ minHeight: ROW_MIN_HEIGHT }}
            >
            ...
            <button
              ...
              className="w-full rounded-xl px-4 py-3 text-left text-gray-700 font-medium hover:bg-gray-100 active:bg-gray-200"
              style={{ minHeight: ROW_MIN_HEIGHT }}
            >
